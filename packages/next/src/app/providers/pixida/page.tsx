...
export default function PixidaProfilePage() {
  ...
  const spaces = [
    {
      ...
      price: "€2,800/month",
      description:
        "Open workspace designed for cross-functional teams and agile development. Perfect for AI/ML projects and rapid prototyping.",
      features: [
        "3D Printer Access",
    ...
    },
    {
      ...
      price: "€1,200/month",
      description:
        "Intimate workshop space ideal for focused project work and client meetings. Premium location with natural light.",
      features: [
    ...
    },
    {
      ...
      price: "€2,200/month",
      description:
        "Hardware-focused workspace with access to our engineering lab. Perfect for IoT development and sensor technology projects.",
      features: [
        "Hardware Lab Access",
  ...
  const prevImage = () => {
    setCurrentImageIndex(
      (prev) => (prev - 1 + currentSpace.images.length) % currentSpace.images.length
    );
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 scroll-smooth">
        ...
        <div className="relative z-20 text-center text-white max-w-4xl px-6">
          <div className="mb-8 animate-fade-in">
            <div className="w-32 h-32 mx-auto bg-white/95 backdrop-blur-sm rounded-full flex items-center justify-center mb-6 shadow-2xl">
              <span className="text-4xl font-bold" style={{ color: "rgb(255, 0, 153)" }}>
                P
              </span>
            </div>
          ...
          <Button
            ...
            onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "rgb(230, 0, 138)")}
            onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "rgb(255, 0, 153)")}
          >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              More than just workspace – we're your innovation partner in Germany's dynamic tech
              ecosystem
            </p>
          </div>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover-lift">
              <CardHeader>
                <div
                  ...
                  style={{ backgroundColor: "rgba(255, 0, 153, 0.1)" }}
                >
              ...
              <CardContent>
                <p className="text-gray-700 leading-relaxed">
                  ...
                  Mittelstand excellence and cutting-edge technology. We foster collaboration that
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover-lift">
              ...
              <CardContent>
                <p className="text-gray-700 leading-relaxed">
                  ...
                  companies navigate Industry 4.0 while maintaining the quality and precision that
                  defines German engineering.
                </p>
              </CardContent>
            </Card>
      ...
      <section id="projects" className="py-16 px-6 bg-gradient-to-r from-blue-50 to-slate-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover the cutting-edge projects that showcase our expertise and the collaborative
          ...
          <div className="flex overflow-x-auto space-x-6 pb-6 scroll-smooth custom-scrollbar">
            {projects.map((project, index) => (
              <Card
                key={index}
                className="min-w-[380px] bg-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover-lift group"
              >
          ...
          <div className="text-center mt-8">
            <Button
              ...
              style={{ borderColor: "rgb(255, 0, 153)", backgroundColor: "rgb(255, 0, 153)" }}
            >
              View All Projects
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-8">What We're Looking For</h2>

          <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
            <CardContent className="p-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-semibold mb-4" style={{ color: "rgb(255, 0, 153)" }}>
                    Ideal Partners
                  </h3>
                  <ul className="text-left space-y-3 text-gray-700">
                    <li className="flex items-start">
                      <span style={{ color: "rgb(255, 0, 153)" }} className="mr-2">
                        •
                      </span>
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex space-x-2">
                      <Button variant="outline" size="sm" onClick={prevSpace} className="p-2">
                        <ChevronLeft className="w-4 h-4" />
                      </Button>
                      <Button variant="outline" size="sm" onClick={nextSpace} className="p-2">
                  ...
                  <p className="text-gray-700 mb-6 leading-relaxed">{currentSpace.description}</p>
                  ...
                  <Button
                    ...
                    style={{ backgroundColor: "rgb(255, 0, 153)" }}
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.backgroundColor = "rgb(230, 0, 138)")
                    }
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.backgroundColor = "rgb(255, 0, 153)")
                    }
                  >
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Hear from our current partners about their experience in the Pixida innovation
              ecosystem
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  <div
                    ...
                    style={{
                      background: "linear-gradient(135deg, rgb(255, 0, 153), rgb(200, 0, 120))",
                    }}
                  >
                    AI
                  </div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  "Pixida's Innovation Lab gave us access to industry-grade testing equipment and
                  direct collaboration with automotive OEMs. We've accelerated our development by 18
                  months."
                </p>
            ...
            <Card className="bg-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover-lift">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  "The collaboration opportunities at Pixida are unmatched. We've partnered on three
                  major Industry 4.0 projects and expanded our client base by 300%."
                </p>
                <div className="flex text-yellow-400">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="w-4 h-4 fill-current" />
            ...
            <Card className="bg-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover-lift">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  "Being part of Pixida's ecosystem connected us with traditional Mittelstand
                  companies looking for digital transformation. Perfect cultural fit."
                </p>
                <div className="flex text-yellow-400">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="w-4 h-4 fill-current" />
          ...
          <div className="mt-16 bg-gradient-to-r from-blue-50 to-slate-50 rounded-2xl p-8">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-3xl font-bold mb-2" style={{ color: "rgb(255, 0, 153)" }}>
                  25+
                </div>
      ...
      <section
        id="contact"
        className="py-20 px-6 bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 text-white relative overflow-hidden"
      >
        {/* Background Pattern */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-blue-100 leading-relaxed">
                Join our innovation ecosystem and become part of Germany's digital transformation
                story. Let's build the technologies that will define tomorrow's Mittelstand.
              </p>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <select className="w-full px-4 py-3 rounded-lg bg-white/20 border border-white/30 text-white focus:outline-none focus:ring-2 focus:ring-white/50">
                      ...
                      <option value="automotive" className="text-gray-800">
                        Automotive
                      </option>
                      <option value="manufacturing" className="text-gray-800">
                        Manufacturing
                      </option>
                      <option value="ai-ml" className="text-gray-800">
                        AI/ML
                      </option>
                  ...
                  <Button
                    className="w-full text-blue-900 font-semibold py-3"
                    style={{ backgroundColor: "rgb(255, 0, 153)" }}
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.backgroundColor = "rgb(230, 0, 138)")
                    }
